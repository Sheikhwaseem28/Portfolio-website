...
export const Experience = () => {
  return (
    <div className="border-b border-neutral-900 pb-4">
       ...
       initial={{opacity: 0, y: -100}} transition={{duration:0.5}} className="my-20 text-center
         text-4xl">Experience</motion.h1>
         <div>
                ...
                <div key={index} className="mb-8 flex flex-wrap
                 lg:justify-center">
                   ...
                   initial={{opacity: 0, x: -100}} transition={{duration:1}} className="w-full lg:w-1/4">
                    ...
                    <motion.div whileInView={{opacity:1, x:0}} 
                   initial={{opacity: 0, x: 100}} transition={{duration:1.5}} className="w-full max-w-xl lg:w-3/4">
